...
describe Person do
  ...
  context 'it sorts by desired attribute' do
    it 'sorts by favorite color descending, then by last name ascending' do
      people_by_color = [Person.sort_by_color.each {|person| people <<person.to_hash}]
    ...
    it 'sorts by birth date ascending' do
      people_by_date = [Person.sort_by_date.each {|person| people <<person.to_hash}]
    	expect(people_by_date).to eq([{"FirstName"=> "Donna", "LastName"=> "Moss", "FavoriteColor"=> "amber", "DateOfBirth"=> "2016-02-25"}, {"FirstName"=> "Josh", "LastName"=> "Lyman", "FavoriteColor"=> "tan", "DateOfBirth"=> "2017-01-19"}, {"FirstName"=> "Laura", "LastName"=> "Moreno", "FavoriteColor"=> "cerulean", "DateOfBirth"=> "2017-01-23"}])
    end

    it 'sorts by last name descending' do
    	expect(Person.sort_by_surname).to eq([{"FirstName"=> "Donna", "LastName"=> "Moss", "FavoriteColor"=> "amber", "DateOfBirth"=> "2016-02-25"}, {"FirstName"=> "Laura", "LastName"=> "Moreno", "FavoriteColor"=> "cerulean", "DateOfBirth"=> "2017-01-23"}, {"FirstName"=> "Josh", "LastName"=> "Lyman", "FavoriteColor"=> "tan", "DateOfBirth"=> "2017-01-19"}])
    end
  end
